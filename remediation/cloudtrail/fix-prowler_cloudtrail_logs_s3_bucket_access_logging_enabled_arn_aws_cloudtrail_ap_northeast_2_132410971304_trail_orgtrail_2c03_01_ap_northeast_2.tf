resource "aws_s3_bucket_policy" "fix_cloudtrail_accesslog_target_policy_c37f4d3c24" {
...
resource "aws_s3_bucket_logging" "fix_cloudtrail_bucket_logging_c37f4d3c24" {
  bucket        = "trail-logs-2c03-ap-northeast-2-01"
  target_bucket = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_prefix = "s3-access-logs/"
  depends_on    = [aws_s3_bucket_policy.fix_cloudtrail_accesslog_target_policy_c37f4d3c24]
}
