resource "aws_s3_bucket_policy" "fix_cloudtrail_accesslog_target_policy_edab91469a" {
...
resource "aws_s3_bucket_logging" "fix_cloudtrail_bucket_logging_edab91469a" {
  bucket        = "trail-logs-fa1c-ap-northeast-2-01"
  target_bucket = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_prefix = "s3-access-logs/"
  depends_on    = [aws_s3_bucket_policy.fix_cloudtrail_accesslog_target_policy_edab91469a]
}
