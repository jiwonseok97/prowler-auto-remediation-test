resource "aws_s3_bucket_policy" "fix_cloudtrail_accesslog_target_policy_d7a94d534a" {
...
resource "aws_s3_bucket_logging" "fix_cloudtrail_bucket_logging_d7a94d534a" {
  bucket        = "trail-logs-fa1c-ap-northeast-2-02"
  target_bucket = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_prefix = "s3-access-logs/"
  depends_on    = [aws_s3_bucket_policy.fix_cloudtrail_accesslog_target_policy_d7a94d534a]
}
