resource "aws_s3_bucket_policy" "fix_cloudtrail_accesslog_target_policy_b05c6d342b" {
...
resource "aws_s3_bucket_logging" "fix_cloudtrail_bucket_logging_b05c6d342b" {
  bucket        = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_bucket = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_prefix = "s3-access-logs/"
  depends_on    = [aws_s3_bucket_policy.fix_cloudtrail_accesslog_target_policy_b05c6d342b]
}
