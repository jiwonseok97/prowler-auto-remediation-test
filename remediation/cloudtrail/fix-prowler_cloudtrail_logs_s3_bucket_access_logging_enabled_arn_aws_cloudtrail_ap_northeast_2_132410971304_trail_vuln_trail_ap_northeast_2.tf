resource "aws_s3_bucket_policy" "fix_cloudtrail_accesslog_target_policy_87323435bd" {
...
resource "aws_s3_bucket_logging" "fix_cloudtrail_bucket_logging_87323435bd" {
  bucket        = "vuln-cloudtrail-132410971304-ap-northeast-2"
  target_bucket = "aws-cloudtrail-logs-132410971304-0971c04b"
  target_prefix = "s3-access-logs/"
  depends_on    = [aws_s3_bucket_policy.fix_cloudtrail_accesslog_target_policy_87323435bd]
}
